...
public class AppResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler( {
            CharacterNotFoundException.class, FilmNotFoundException.class, PlanetNotFoundException.class,
            VehicleNotFoundException.class, StarshipNotFoundException.class, PageCharacterNotFoundException.class
    })
